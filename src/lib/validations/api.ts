...
export const patchSolicitud = z
  .object({
    estado: z
      ...
      .optional(),
    tipo_cocina: z.enum(["politex_negro", "melamina_litio", "politex_gris_grafito", "melamina_grafito_scotch", "polimero_blanco_gloss"]).optional(),
    modo: z.enum(["rediseno", "diseno"]).optional(),
